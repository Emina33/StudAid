...
namespace StudAid.WinUI
{
    public partial class mdiMain : Form
    {
        ...
        private void appUsersToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        {
            frmDocumentsList childForm = new frmDocumentsList();
            childForm.MdiParent = this;
            childForm.Text = "Window " + childFormNumber++;
            childForm.WindowState = FormWindowState.Maximized;
            childForm.Show();
        ...
        {
            frmLocationsList childForm = new frmLocationsList();
            childForm.MdiParent = this;
            childForm.Text = "Window " + childFormNumber++;
            childForm.WindowState = FormWindowState.Maximized;
            childForm.Show();
        ...
        {
            frmNewLocation childForm = new frmNewLocation();
            childForm.MdiParent = this;
            childForm.Text = "Window " + childFormNumber++;
            childForm.WindowState = FormWindowState.Maximized;
            childForm.Show();
